...
theorem pierpont_split_37_163 :
    ...
    ¬ ThreeSmooth 42 ∧ ¬ ThreeSmooth 66 ∧ ¬ ThreeSmooth 78 := by decide

/-- **the exception at 11**: among {5, 7, 11, 13, 17, 19}, only `11` fails the Pierpont grade (`10 = 2·5`) —
...
theorem eleven_not_pierpont :
    ...
    ThreeSmooth 12 ∧ ThreeSmooth 16 ∧ ThreeSmooth 18 := by decide
...
theorem atlas_pierpont_floor :
    ThreeSmooth 4 ∧ ThreeSmooth 12 ∧ ¬ ThreeSmooth 10 ∧ ¬ ThreeSmooth 180 := by decide
...
theorem six_q_plus_one_ladder :
    ...
    42 = 2 * 3 * 7 ∧ 66 = 2 * 3 * 11 ∧ 78 = 2 * 3 * 13 := by decide
